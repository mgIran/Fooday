...
class MellatPayment extends CApplicationComponent
{
	...
	public function init( )
	{
		...
		$this->terminalId=yii::app()->functions->getOption('admin_mellat_terminal_num');
		$this->userName=yii::app()->functions->getOption('admin_mellat_username');
		$this->userPassword=yii::app()->functions->getOption('admin_mellat_password');
