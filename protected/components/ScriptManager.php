...
class ScriptManager
{
	public static function RegisterAllJSFile()
	{
		...
		/*
		   ...
		   *********************************************
		 */
		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.easing.1.3.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/SmoothScroll.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.scrollTo.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.localScroll.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.viewport.mini.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.countTo.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.appear.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.sticky.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.fitvids.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/owl.carousel.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/isotope.pkgd.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/imagesloaded.pkgd.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/jquery.magnific-popup.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/gmap3.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/WOW.min.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/all.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/persian-date.js", CClientScript::POS_END);

		$cs->registerScriptFile($baseUrl . "/assets/js/persian-datepicker-0.4.5.min.js", CClientScript::POS_END);
	}
	...
	public static function registerAllCSSFiles()
	{
		...
		$cs->registerCssFile($baseUrl . '/assets/css/rahbod.css');
		$cs->registerCssFile($baseUrl . '/assets/css/persian-datepicker-0.4.5.min.css');
	}
